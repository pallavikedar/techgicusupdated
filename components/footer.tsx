...
import { Facebook, Twitter, Instagram, Linkedin, ArrowUp, Send, YoutubeIcon } from "lucide-react"
  ...
  return (
    <footer className="bg-black border-t border-gray-800">
      <div className="container mx-auto px-4">
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20">
          <div>
            <Link href="/" className="text-2xl font-bold text-green-400 mb-6 inline-block ">
            <Image
            src={Logo}
            alt="Techgicus Logo"
 ...
 INNOVATION FOR CUSTOMERS
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="bg-gray-800 hover:bg-green-400 text-white hover:text-black p-2 rounded-full transition-colors duration-300" target="_blank"
              >
        ...
        <div className="py-6 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} <a href="/">Techgicus</a>. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="#" className="text-gray-400 hover:text-green-400 text-sm transition-colors duration-300">
              Privacy Policy
            </Link>
            <Link href="#" className="text-gray-400 hover:text-green-400 text-sm transition-colors duration-300">
              Terms of Service
